...
def test_load_wan_models():
	...
	tg_transformer = tg_model_class.from_pretrained("Wan-AI/Wan2.1-T2V-14B-Diffusers", subfolder="transformer", torch_dtype=tg_adapter.float32, low_cpu_mem_usage = True)
	...
	hf_transformer = hf_model_class.from_pretrained("Wan-AI/Wan2.1-T2V-14B-Diffusers", subfolder="transformer", torch_dtype=torch.float32, low_cpu_mem_usage = True)
