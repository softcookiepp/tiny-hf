...
class AltCLIPTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from tiny_hf.transformers.import AltCLIPTextModel, AltCLIPTextConfig
...
class AltCLIPVisionConfig(PretrainedConfig):
    ...
    ```python
    >>> from tiny_hf.transformers.import AltCLIPVisionConfig, AltCLIPVisionModel
...
class AltCLIPConfig(PretrainedConfig):
    ...
    ```python
    >>> from tiny_hf.transformers.import AltCLIPConfig, AltCLIPModel
