...
class SiglipTokenizer(PreTrainedTokenizer):
    ...
    @property
    # Copied from tiny_hf.transformers.models.t5.tokenization_t5.T5Tokenizer.vocab_size
    def vocab_size(self):
    ...
    # Copied from tiny_hf.transformers.models.t5.tokenization_t5.T5Tokenizer.__setstate__
    ...
    @property
    # Copied from tiny_hf.transformers.models.t5.tokenization_t5.T5Tokenizer.unk_token_length
    ...
    # Copied from tiny_hf.transformers.models.t5.tokenization_t5.T5Tokenizer._convert_token_to_id
    def _convert_token_to_id(self, token):
        """Converts a token (str) in an id using the vocab."""
        return self.sp_model.piece_to_id(token)

    # Copied from tiny_hf.transformers.models.t5.tokenization_t5.T5Tokenizer._convert_id_to_token
