...
# Copied from tiny_hf.transformers.models.donut.convert_donut_to_pytorch.rename_key
def rename_key(name):
...
# Copied from tiny_hf.transformers.models.donut.convert_donut_to_pytorch.convert_state_dict
