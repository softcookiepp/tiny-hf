...
class NougatImageProcessor(BaseImageProcessor):
    ...
    # Copied from tiny_hf.transformers.models.donut.image_processing_donut.DonutImageProcessor.align_long_axis
    def align_long_axis(
        self,
        image: np.ndarray,
        size: Dict[str, int],
    ...
    # Copied from tiny_hf.transformers.models.donut.image_processing_donut.DonutImageProcessor.thumbnail
    def thumbnail(
        self,
        image: np.ndarray,
        size: Dict[str, int],
    ...
    # Copied from tiny_hf.transformers.models.donut.image_processing_donut.DonutImageProcessor.resize
    def resize(
        self,
        image: np.ndarray,
        size: Dict[str, int],
