...
# Copied from tiny_hf.transformers.models.beit.modeling_beit.BeitDropPath with Beit->FocalNet
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinPreTrainedModel with Swin->FocalNet,swin->focalnet
...
class FocalNetForMaskedImageModeling(FocalNetPreTrainedModel):
    ...
    def forward(
        ...
        Examples:
        ```python
        >>> from tiny_hf.transformers.import AutoImageProcessor, FocalNetConfig, FocalNetForMaskedImageModeling
        >>> import tg_adapter as torch
...
class FocalNetForImageClassification(FocalNetPreTrainedModel):
    # Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinForImageClassification.__init__ with Swin->FocalNet, swin->focalnet
    def __init__(self, config):
        super().__init__(config)
