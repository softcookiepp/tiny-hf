...
class AlbertConfig(PretrainedConfig):
    ...
    ```python
    >>> from tiny_hf.transformers.import AlbertConfig, AlbertModel
...
# Copied from tiny_hf.transformers.models.bert.configuration_bert.BertOnnxConfig with Roberta->Albert
