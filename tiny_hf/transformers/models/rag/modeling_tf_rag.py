...
class TFRagPreTrainedModel(TFPreTrainedModel):
    ...
    def from_pretrained_question_encoder_generator(
        ...
        **kwargs,
        ...
        ```python
        >>> from tiny_hf.transformers.import RagRetriever, TFRagModel
...
class TFRagModel(TFRagPreTrainedModel):
    ...
    def call(
        ...
        **kwargs,
        ...
        ```python
        >>> from tiny_hf.transformers.import AutoTokenizer, RagRetriever, TFRagModel
...
class TFRagTokenForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> import tensorflow as tf
        >>> from tiny_hf.transformers.import AutoTokenizer, RagRetriever, TFRagTokenForGeneration
...
class TFRagSequenceForGeneration(TFRagPreTrainedModel, TFCausalLanguageModelingLoss):
    ...
    def call(
        ...
        **kwargs,  # needs kwargs for generation
        ...
        ```python
        >>> from tiny_hf.transformers.import AutoTokenizer, RagRetriever, TFRagSequenceForGeneration
