...
class UdopTokenizerFast(PreTrainedTokenizerFast):
    ...
    # Copied from tiny_hf.transformers.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast.tokenize
    ...
    # Copied from tiny_hf.transformers.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast._pad
    def _pad(
        self,
    ...
    # Copied from tiny_hf.transformers.models.layoutxlm.tokenization_layoutxlm_fast.LayoutXLMTokenizerFast.save_vocabulary
