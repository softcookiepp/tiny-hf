...
class ClvpProcessor(ProcessorMixin):
    ...
    # Copied from tiny_hf.transformers.models.whisper.processing_whisper.WhisperProcessor.batch_decode with Whisper->Clvp
    ...
    # Copied from tiny_hf.transformers.models.whisper.processing_whisper.WhisperProcessor.decode with Whisper->Clvp
