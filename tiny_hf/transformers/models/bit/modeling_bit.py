...
# Copied from tiny_hf.transformers.models.convnext.modeling_convnext.drop_path
...
# Copied from tiny_hf.transformers.models.beit.modeling_beit.BeitDropPath with Beit->Bit
