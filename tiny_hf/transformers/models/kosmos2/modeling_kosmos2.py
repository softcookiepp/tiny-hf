...
# Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPVisionEmbeddings with CLIP->Kosmos2
...
# Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPAttention with CLIP->Kosmos2Vision
...
# Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPMLP with CLIP->Kosmos2Vision
...
# Copied from tiny_hf.transformers.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->Kosmos2Vision
...
# Copied from tiny_hf.transformers.models.altclip.modeling_altclip.AltCLIPEncoder with AltCLIP->Kosmos2Vision
...
class Kosmos2VisionTransformer(nn.Module):
    # Copied from tiny_hf.transformers.models.altclip.modeling_altclip.AltCLIPVisionTransformer.__init__ with AltCLIPVision->Kosmos2Vision,ALTCLIP_VISION->KOSMOS2_VISION,AltCLIP->Kosmos2Vision
    def __init__(self, config: Kosmos2VisionConfig):
        super().__init__()
        self.config = config
...
class Kosmos2TextSinusoidalPositionalEmbedding(nn.Module):
    ...
    # Copied from tiny_hf.transformers.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.__init__
    ...
    # Copied from tiny_hf.transformers.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.make_weights
    ...
    @staticmethod
    # Copied from tiny_hf.transformers.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.get_embedding
    ...
    # Copied from tiny_hf.transformers.models.m2m_100.modeling_m2m_100.M2M100SinusoidalPositionalEmbedding.create_position_ids_from_inputs_embeds
...
class Kosmos2VisionModel(Kosmos2PreTrainedModel):
    ...
    # Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPVisionModel.__init__ with CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2,self.vision_model->self.model
    def __init__(self, config: Kosmos2VisionConfig):
    ...
    # Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPVisionModel.get_input_embeddings with CLIP_VISION->KOSMOS2_VISION,CLIP->Kosmos2,self.vision_model->self.model
...
class Kosmos2TextForCausalLM(Kosmos2PreTrainedModel, GenerationMixin):
    ...
    @staticmethod
    # Copied from tiny_hf.transformers.models.umt5.modeling_umt5.UMT5ForConditionalGeneration._reorder_cache
...
class Kosmos2Model(Kosmos2PreTrainedModel):
    ...
    def forward(
        ...
        >>> import requests
        >>> from tiny_hf.transformers.import AutoProcessor, Kosmos2Model
...
class Kosmos2ForConditionalGeneration(Kosmos2PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        >>> from PIL import Image
        >>> import requests
        >>> from tiny_hf.transformers.import AutoProcessor, Kosmos2ForConditionalGeneration
