...
@dataclass
# Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPTextModelOutput with CLIP->Clap
...
@dataclass
# Copied from tiny_hf.transformers.models.clip.modeling_clip.CLIPOutput with CLIP->Clap, vision->audio, Vision->Audio, image->audio
...
# Adapted from tiny_hf.transformers.models.swin.modeling_swin.SwinDropPath
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinSelfAttention with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinSelfOutput with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinAttention with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinIntermediate with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinOutput with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinLayer with SwinDropPath->ClapDropPath, Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinStage with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.swin.modeling_swin.SwinPatchMerging with Swin->ClapAudio
...
# Copied from tiny_hf.transformers.models.roberta.modeling_roberta.RobertaEmbeddings with Roberta->ClapText, persistent=False->persistent=True
...
# Copied from tiny_hf.transformers.models.bert.modeling_bert.BertSelfAttention with Bert->ClapText
...
# Copied from tiny_hf.transformers.models.bert.modeling_bert.BertAttention with Bert->ClapText,BERT->CLAP_TEXT
...
# Copied from tiny_hf.transformers.models.bert.modeling_bert.BertLayer with Bert->ClapText
...
# Copied from tiny_hf.transformers.models.bert.modeling_bert.BertEncoder with Bert->ClapText
...
class ClapAudioModel(ClapPreTrainedModel):
    ...
    def forward(
        ...
        >>> from tiny_hf.transformers.import AutoProcessor, ClapAudioModel
...
class ClapModel(ClapPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> from tiny_hf.transformers.import AutoTokenizer, ClapModel
    ...
    def get_audio_features(
        ...
        ```python
        >>> from tiny_hf.transformers.import AutoFeatureExtractor, ClapModel
        >>> import tg_adapter as torch
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from tiny_hf.transformers.import AutoProcessor, ClapModel
...
class ClapTextModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from tiny_hf.transformers.import AutoTokenizer, ClapTextModelWithProjection
...
class ClapAudioModelWithProjection(ClapPreTrainedModel):
    ...
    def forward(
        ...
        ```python
        >>> from datasets import load_dataset
        >>> from tiny_hf.transformers.import ClapAudioModelWithProjection, ClapProcessor
