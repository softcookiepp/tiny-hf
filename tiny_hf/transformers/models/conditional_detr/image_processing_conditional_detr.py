...
# Copied from tiny_hf.transformers.models.detr.image_processing_detr.prepare_coco_detection_annotation with DETR->ConditionalDetr
...
# Copied from tiny_hf.transformers.models.detr.image_processing_detr.prepare_coco_panoptic_annotation with DETR->ConditionalDetr
...
# Copied from tiny_hf.transformers.models.detr.image_processing_detr.post_process_panoptic_sample with DetrForSegmentation->ConditionalDetrForSegmentation
...
class ConditionalDetrImageProcessor(BaseImageProcessor):
    ...
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.__init__
    def __init__(
        self,
    ...
    @classmethod
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.from_dict with Detr->ConditionalDetr
    ...
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.prepare_annotation with DETR->ConditionalDetr
    ...
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.preprocess
    def preprocess(
        self,
        images: ImageInput,
        annotations: Optional[Union[AnnotationType, List[AnnotationType]]] = None,
    ...
    # Copied from tiny_hf.transformers.models.deformable_detr.image_processing_deformable_detr.DeformableDetrImageProcessor.post_process_object_detection with DeformableDetr->ConditionalDetr
    ...
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_semantic_segmentation with Detr->ConditionalDetr
    ...
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_instance_segmentation with Detr->ConditionalDetr
    ...
    # Copied from tiny_hf.transformers.models.detr.image_processing_detr.DetrImageProcessor.post_process_panoptic_segmentation with Detr->ConditionalDetr
