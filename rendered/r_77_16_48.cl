__kernel void r_77_16_48(__global float* data0_77, __global float* data1_59136) {
  ...
  *(acc0+0) = 0.0;
  for (int ridx1002 = 0; ridx1002 < 48; ridx1002++) {
    float val0 = (*(data1_59136+((lidx0*48)+ridx1002+(gidx0*768))));
    *(acc0+0) = ((*(acc0+0))+val0);
  }
  *(temp0+lidx0) = (*(acc0+0));
