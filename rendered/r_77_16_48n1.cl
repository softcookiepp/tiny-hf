__kernel void r_77_16_48n1(__global float* data0_77, __global float* data1_59136, __global float* data2_77) {
  ...
  *(acc1+0) = 0.0;
  *(acc0+0) = 0.0;
  float val0 = (*(data2_77+gidx0));
  for (int ridx1002 = 0; ridx1002 < 48; ridx1002++) {
    float val1 = (*(data1_59136+((lidx0*48)+ridx1002+(gidx0*768))));
    float alu2 = (val1-val0);
