__kernel void r_77_16_48n9(__global float* data0_77, __global float* data1_59136, __global float* data2_59136, __global float* data3_59136, __global float* data4_59136, __global float* data5_59136, __global float* data6_77) {
  ...
  *(acc0+0) = 0.0;
  ...
  for (int ridx1002 = 0; ridx1002 < 48; ridx1002++) {
    ...
    float alu3 = ((val1+val2+val3+val4+val5)-val0);
